...
const FAQS = [
// ── Devis & prix ──
{ cat: "Devis & prix", q: "Le devis est-il vraiment gratuit ?", a: "Oui, totalement gratuit et sans engagement. Vous décrivez votre déménagement, on revient sous 24h avec un prix clair et définitif. Aucune carte bancaire, aucun numéro surtaxé. On revient vers vous si vous ne répondez pas, mais jamais plus de trois fois, et on s'arrête au premier « non »." },
...
{ cat: "Devis & prix", q: "Le prix annoncé peut-il changer le jour J ?", a: "Non. Le prix annoncé est le prix payé, point. La seule exception : si le volume réel diffère nettement de ce qui a été décrit (deux fois plus de cartons que prévu, un meuble « oublié » de 200 kg). C'est tout l'intérêt de bien décrire votre inventaire en amont." },
...
// ── Nos formules ──
{ cat: "Nos formules", q: "Quelles sont vos formules ?", a: "Trois, du plus autonome au tout compris : Standard (l'essentiel), Premium (le confort, la plus demandée) et Luxe (le clé en main de A à Z). Chacune reprend la précédente et ajoute du service." },
{ cat: "Nos formules", q: "Que comprend la formule Standard ?", a: "L'essentiel bien fait : transport avec véhicule adapté, chargement et déchargement par notre équipe, déménagement local ou longue distance, et assurance incluse. Vous préparez vos cartons, on gère le muscle, la route et la casse." },
{ cat: "Nos formules", q: "Que comprend la formule Premium ?", a: "Tout le Standard, plus : emballage des objets fragiles par notre équipe, protection intégrale du mobilier (couvertures, housses, film), démontage et remontage des meubles, et manutention sécurisée. C'est notre formule la plus choisie." },
{ cat: "Nos formules", q: "Que comprend la formule Luxe ?", a: "Le grand jeu : tout Premium, plus l'emballage de la totalité de vos cartons (objets fragiles compris), le déballage et la mise en place à l'arrivée, et une protection spécifique des objets précieux, œuvres d'art et vaisselle. Vous n'avez qu'à ouvrir la porte." },
{ cat: "Nos formules", q: "Quelle formule choisir ?", a: "Dans le doute, prenez Premium : c'est le meilleur rapport confort/prix pour la plupart des déménagements. On ajuste ensemble au moment du devis selon votre temps disponible et votre budget." },
...
{ cat: "Le jour J", q: "Démontez-vous les meubles ?", a: "Oui, dès la formule Premium : démontage au départ, remontage à l'arrivée. Lit, armoire, dressing, table — on s'occupe de tout, revissé comme il faut. La visserie est repérée et conservée pièce par pièce." },
...
{ cat: "Emballage & objets spéciaux", q: "Dois-je emballer moi-même mes cartons ?", a: "Cela dépend de la formule. En Standard et Premium, vous préparez vos cartons (on protège le mobilier et on démonte). En Luxe, notre équipe emballe absolument tout pour vous, objets fragiles compris." },
...
{ cat: "Emballage & objets spéciaux", q: "Gérez-vous les œuvres d'art et la vaisselle précieuse ?", a: "Oui, avec un emballage renforcé sur mesure (caisses, mousse, coins de protection) et une assurance valeur déclarée pour les pièces de grande valeur. C'est inclus en formule Luxe." },
