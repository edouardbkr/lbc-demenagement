...
const ROUTES = {
  "nice-paris": {
    ...
    faq: [
      ...
      { q: "Combien coûte un déménagement Nice–Paris ?", a: "Le prix dépend du volume, de la formule, des accès aux deux adresses, de la saison et des options. Ces cinq éléments sont chiffrés dans le devis, qui est ferme : le prix annoncé est le prix payé, sans supplément le jour J." },
      { q: "Quand faut-il réserver ?", a: "Trois à quatre semaines à l'avance, et davantage entre juin et septembre. Un départ en milieu de mois, en semaine et hors été se cale plus facilement. Les départs serrés restent possibles, il suffit d'appeler." }
    ]
  },
  "nice-lyon": {
  ...
  "nice-barcelone": {
    ...
    deep: [
      ...
      { t: "Un trajet côtier fluide", p: "À ≈ 660 km le long de la Méditerranée par la frontière du Perthus, Barcelone est une destination internationale relativement proche et un trajet agréable et direct. Camion dédié et plombé, une seule équipe du chargement à la livraison, mobilier protégé sur toute la route. Pas de groupage ni de transbordement, et un garde-meuble relais possible si votre logement barcelonais n'est pas prêt à temps." }
    ],
    faq: [
