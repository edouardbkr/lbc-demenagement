...
const CITIES = {
  ...
  "villefranche-sur-mer": {
    ...
    deep: [
      ...
      { t: "Villefranche vers Nice, la porte à côté", p: "Beaucoup de déménagements villefranchois se font vers Nice, à sept kilomètres par la Basse Corniche. La distance ne coûte rien, mais le temps de portage, lui, compte. C'est pourquoi le devis sur cette commune se joue sur l'accès et pas sur le kilométrage. On le dit clairement plutôt que de gonfler une ligne de transport qui n'a pas lieu d'être." }
    ],
    faq: [
      ...
      { q: "Un Villefranche–Nice coûte-t-il cher ?", a: "Sept kilomètres, le transport ne pèse presque rien. Ce qui compte sur cette commune, c'est le temps d'accès, et c'est lui qu'on chiffre." },
