/**
 * route-fond.jsx — le contenu de fond des pages trajets, un territoire par destination.
 *
 * POURQUOI CE FICHIER
 * Les treize pages trajets etaient la famille la plus courte du site, autour de
 * 1 100 mots, avec un squelette commun : meme intro, memes points, meme process.
 * Leur recouvrement mesure restait bas (10 %) uniquement parce qu'elles etaient
 * courtes. En les allongeant sans les differencier, il aurait grimpe.
 *
 * REGLE D'ECRITURE
 * Un trajet ne se raconte pas par la distance mais par ce qui attend a l'arrivee.
 * Chaque destination a donc son territoire : le stationnement parisien, les
 * pentes lyonnaises, la douane suisse, la zone a trafic limite italienne. Si une
 * phrase pouvait etre recopiee sur une autre destination, elle n'a rien a faire ici.
 *
 * CONTROLE  node audit-complet.js trajet   doit rester sous 20 %.
 */
...
const ROUTE_FOND = {
  ...
  "nice-lyon": {
    ...
    sections: [
      ...
      { t: "Une livraison sur deux jours", d: "La distance autorise un schéma en deux temps confortable : chargement complet à Nice dans la journée, route et repos réglementaire, livraison le lendemain matin à Lyon. Cela permet d'arriver en début de créneau plutôt qu'en fin de journée fatiguée, ce qui change la qualité du remontage. Nous privilégions ce schéma et nous l'annonçons au devis, avec la date de livraison ferme qui va avec." }
    ],
    etapes: [
      { h: "J-15", t: "Demande d'autorisation de stationnement à Lyon, adaptée au secteur concerné." },
      { h: "J-3", t: "Vérification des cotes de cage d'escalier et de la déclivité de la rue à l'arrivée." },
      { h: "Jour 1", t: "Chargement à Nice, calage pour la route, départ hors des créneaux de saturation." },
      { h: "Jour 2", t: "Livraison lyonnaise en début de matinée, remontage à l'équipe reposée." }
    ],
    erreurs: [
      { t: "Partir un vendredi de chassé-croisé", d: "La vallée du Rhône se bloque à dates connues. Trois heures perdues sur la route font manquer le créneau d'arrivée." },
      { t: "Sous-estimer les pentes de la Croix-Rousse", d: "Rues en déclivité et escaliers de canuts : caler un camion et sortir un meuble n'y vont pas de soi. Cela se vérifie avant." },
      { t: "Livrer en fin de journée", d: "Après six heures de route, un remontage se fait moins bien. Le schéma sur deux jours coûte peu et change le résultat." }
    ]
  },
  ...
  "nice-lausanne": {
    ...
    sections: [
      { t: "Une ville qui monte de la gare à la cathédrale", d: "Lausanne est construite sur des collines, et le dénivelé entre le bord du lac à Ouchy et les hauteurs dépasse largement ce qu'on imagine. Les rues de la vieille ville sont étroites, en pente, parfois en escalier, et l'accès véhicule y est limité. Le point de stationnement praticable peut se trouver loin de la porte, avec un portage en montée. Nous relevons ce parcours avant le devis, parce qu'il détermine le nombre d'équipiers, et nous vérifions la déclivité de la rue, qui conditionne la sécurité du calage." },
      { t: "Un autre canton, d'autres interlocuteurs", d: "La Suisse est fédérale, et les démarches d'annonce d'arrivée, d'inscription au contrôle des habitants et de permis se traitent au niveau communal et cantonal. Ce qui vaut pour Genève ne se transpose pas mécaniquement à Vaud. Nous ne sommes pas votre conseil administratif, mais nous vous indiquons ce que le dossier douanier exige de votre côté et nous adaptons les documents que nous fournissons. Ce point se règle avant le départ, jamais depuis Lausanne." },
      { t: "Neuf cents kilomètres, deux journées", d: "La distance impose un schéma en deux temps avec repos réglementaire, et une arrivée en début de journée plutôt qu'en fin d'après-midi. Sur cette longueur, le calage compte : nous chargeons en respectant la répartition des masses, nous sanglons par rangées et nous comblons les vides, parce que ce sont les vibrations continues qui abîment sur la durée, pas les freinages. La date de livraison est ferme et figure au devis." },
      { t: "Le stockage de part et d'autre", d: "Les prises de poste lausannoises s'accompagnent fréquemment d'un décalage entre la libération du logement niçois et la disponibilité du logement suisse. Nous proposons un garde-meuble relais côté français, avec mobilier inventorié en caisses scellées, livré à la date que vous fixez. Cela évite un double loyer international et, surtout, cela évite de forcer un calendrier qui ne tient pas." }
    ],
    etapes: [
      { h: "J-30", t: "Dossier douanier constitué, inventaire valorisé et justificatif de prise de domicile vaudoise." },
      { h: "J-7", t: "Relevé du parcours de portage à Lausanne : pente, distance, accès véhicule réel." },
      { h: "Jour 1", t: "Chargement à Nice, calage renforcé pour la distance, camion plombé." },
      { h: "Jour 2", t: "Passage de douane, puis livraison lausannoise en journée." }
    ],
    erreurs: [
      { t: "Croire que Lausanne ressemble à Genève", d: "Autre canton, autre relief. La pente lausannoise change la méthode de livraison, et les démarches ne sont pas les mêmes." },
      { t: "Négliger le calage sur neuf cents kilomètres", d: "Ce sont les vibrations continues qui abîment. Un chargement qui a du jeu arrive marqué, sans qu'aucun incident ne se soit produit." },
      { t: "Forcer des dates qui ne se recouvrent pas", d: "Un garde-meuble relais coûte moins qu'un double loyer international et supprime la contrainte de calendrier." }
    ]
  },
  ...
  "nice-bruxelles": {
    ...
    sections: [
      { t: "La maison bruxelloise et son escalier", d: "Le bâti résidentiel bruxellois est dominé par la maison de rangée, étroite en façade, profonde, montant sur trois ou quatre niveaux. L'escalier intérieur est raide, souvent tournant, avec des marches courtes et un jour central inexistant. Un canapé, une armoire ou un matelas grand format n'y passent pas. C'est la raison pour laquelle le monte-meuble est d'usage courant à Bruxelles et non exceptionnel comme ailleurs. Nous prévoyons cette solution dès le devis, avec la réservation de l'emplacement qui va avec." },
      { t: "L'emplacement de stationnement, à réserver auprès de la commune", d: "Bruxelles est divisée en communes qui gèrent chacune leurs autorisations de stationnement pour déménagement, avec leurs propres formulaires, délais et tarifs. La demande se fait auprès de la commune de l'adresse, et les délais varient. Nous engageons la démarche dès que la date est arrêtée, en identifiant la bonne commune, ce qui est la première source d'erreur pour un opérateur qui ne connaît pas la ville. Sans emplacement réservé, ni le camion ni le monte-meuble ne peuvent se poser." },
      { t: "Une ville d'expatriation professionnelle", d: "Les institutions européennes et les organisations qui gravitent autour concentrent une population expatriée avec des calendriers imposés et des prises en charge par l'employeur. Cela suppose un devis conforme, détaillé, avec numéro d'entreprise et attestation d'assurance, apte à entrer dans un dossier de remboursement. Nous l'éditons systématiquement dans ce format. Les délais de dépôt de ces dossiers sont courts, et un devis à refaire fait perdre la fenêtre." },
      { t: "Mille kilomètres, deux jours et un calage soigné", d: "La distance impose un schéma sur deux journées avec repos réglementaire. Sur cette longueur, le calage détermine l'état du mobilier à l'arrivée bien plus que la conduite : répartition des masses, sanglage par rangées, vides comblés. Nous fonctionnons en camion dédié, sans transbordement, avec une date de livraison ferme et non une fourchette de plusieurs jours comme le pratiquent les formules de groupage sur cette destination." }
    ],
    etapes: [
      { h: "J-25", t: "Identification de la commune bruxelloise et dépôt de la demande d'emplacement." },
      { h: "J-15", t: "Réservation du monte-meuble et vérification de l'emprise disponible en façade." },
      { h: "Jour 1", t: "Chargement à Nice, calage renforcé, départ en fin de matinée." },
      { h: "Jour 2", t: "Livraison bruxelloise par la façade, remontage et vérification de l'inventaire." }
    ],
    erreurs: [
      { t: "Croire que le mobilier passera par l'escalier", d: "L'escalier bruxellois est raide et tournant. Le monte-meuble n'est pas une option de confort, c'est la méthode normale sur place." },
      { t: "Se tromper de commune pour l'autorisation", d: "Chaque commune bruxelloise gère la sienne, avec ses délais. Une demande déposée au mauvais endroit ne vaut rien." },
      { t: "Présenter un devis non conforme à l'employeur", d: "Sans numéro d'entreprise ni attestation, le dossier de prise en charge est refusé et la fenêtre de dépôt se referme." }
    ]
  },
  ...
  "nice-luxembourg": {
    ...
    sections: [
      { t: "Une mobilité qui se prépare avec le service du personnel", d: "La plupart de nos clients luxembourgeois déménagent pour une prise de poste, avec une participation de l'employeur aux frais. Cela suppose un devis détaillé et conforme, comportant le numéro d'entreprise, l'attestation d'assurance et le détail des prestations, apte à entrer dans un dossier de remboursement sans être refusé pour un motif de forme. Nous éditons ce document dans le format attendu dès le premier échange. Les délais de dépôt de ces dossiers sont courts et se calculent souvent à partir de la date de prise de fonction." },
      { t: "Des séjours parfois courts, et un retour à prévoir", d: "Une partie de ces mobilités durent deux à quatre ans, ce qui change la façon d'organiser le déménagement. Il est souvent judicieux de ne pas tout emmener : le mobilier volumineux ou peu adapté à un logement locatif peut rester en garde-meuble en France, inventorié en caisses scellées, plutôt que de faire deux fois neuf cents kilomètres. Nous chiffrons les deux options au devis, avec le coût du stockage sur la durée envisagée, et vous décidez sur des chiffres et non sur une impression." },
      { t: "Un parc locatif tendu et des dates fermes", d: "Le marché locatif luxembourgeois est tendu, les baux se prennent vite et les dates d'entrée ne se négocient guère. Cela signifie que la date de livraison doit être ferme, pas approximative. Les formules de groupage annoncent une fourchette de plusieurs jours, ce qui est incompatible avec un état des lieux d'entrée fixé à une date précise. Nous fonctionnons en camion dédié, avec une date d'arrivée engagée au devis." },
      { t: "Trois frontières, aucune formalité", d: "Le trajet traverse plusieurs pays de l'Union sans aucune formalité douanière, ce qui simplifie considérablement les choses par rapport à la Suisse. En revanche les règles de circulation des poids lourds, les restrictions de week-end et de jours fériés varient d'un pays à l'autre et peuvent immobiliser un camion une journée entière. Nous calons le trajet en tenant compte de ces restrictions, ce qui explique que nous refusions parfois un départ un vendredi." }
    ],
    etapes: [
      { h: "J-30", t: "Devis conforme édité pour le dossier employeur, avec numéro d'entreprise et attestation." },
      { h: "J-20", t: "Arbitrage entre ce qui part et ce qui reste en garde-meuble, chiffré sur la durée du séjour." },
      { h: "Jour 1", t: "Chargement à Nice, départ calé hors des restrictions de circulation poids lourds." },
      { h: "Jour 2", t: "Livraison luxembourgeoise à date ferme, compatible avec l'état des lieux d'entrée." }
    ],
    erreurs: [
      { t: "Tout emmener pour un séjour de trois ans", d: "Deux fois neuf cents kilomètres pour du mobilier qui ne servira pas coûte plus que trois ans de garde-meuble. Cela se chiffre." },
      { t: "Accepter une fourchette de livraison", d: "Un état des lieux d'entrée est fixé à une date. Une arrivée « entre le 8 et le 12 » est incompatible avec le marché locatif local." },
      { t: "Partir un vendredi", d: "Les restrictions de circulation des poids lourds varient d'un pays à l'autre et peuvent coûter une journée entière d'immobilisation." }
    ]
  },
  ...
  "nice-barcelone": {
    ...
    sections: [
      ...
      { t: "Le garde-meuble relais, souvent utile", d: "Le marché locatif barcelonais impose fréquemment des dates d'entrée qui ne coïncident pas avec la libération du logement niçois. Nous stockons alors le mobilier en caisses scellées et inventoriées côté français, et nous livrons à la date que vous fixez. Cela évite de payer un double loyer international et de forcer un calendrier que le marché local ne permet pas de tenir." }
    ],
    etapes: [
      { h: "J-25", t: "Vérification de l'éligibilité du véhicule aux zones réglementées et demande de stationnement." },
      { h: "J-10", t: "Relevé des cotes de cabine et de cage à l'arrivée, réservation du monte-meuble si nécessaire." },
      { h: "Jour 1", t: "Chargement à Nice, camion plombé, route côtière par le Perthus." },
      { h: "Jour 2", t: "Livraison barcelonaise, le plus souvent par la façade ou le balcon." }
    ],
    erreurs: [
      { t: "Compter sur l'ascenseur barcelonais", d: "Il prend deux personnes et quelques cartons. Le mobilier passe par la façade, et cela se prévoit au devis." },
      { t: "Ignorer les zones à circulation réglementée", d: "Un véhicule non éligible ne rentre pas dans la ville. Cela se vérifie avant le départ de Nice, pas à l'arrivée." },
      { t: "Caler deux dates qui ne se recouvrent pas", d: "Le marché locatif barcelonais impose ses dates. Le garde-meuble relais coûte moins qu'un double loyer." }
    ]
  },
  ...
  "nice-milan": {
    ...
    sections: [
      { t: "La zone à trafic limité, à traiter avant de partir", d: "Le centre de Milan est encadré par des dispositifs de restriction d'accès, contrôlés par caméras, avec des règles portant à la fois sur le type de véhicule, ses émissions et les horaires. Un utilitaire de déménagement doit disposer de l'autorisation appropriée pour entrer, et cette autorisation se demande à l'avance auprès des services municipaux. Nous engageons cette démarche dès que la date est arrêtée, avec les caractéristiques exactes du véhicule. Une entrée non autorisée est relevée automatiquement et facturée, sans qu'aucune discussion sur place ne soit possible." },
      { t: "Les immeubles milanais et leur cour intérieure", d: "Le bâti résidentiel milanais s'organise fréquemment autour d'une cour intérieure, avec un porche d'entrée dont la hauteur et la largeur conditionnent l'accès. Certains porches acceptent un utilitaire, d'autres non, et cette information ne figure sur aucune carte. Les ascenseurs sont souvent d'origine, étroits, avec des portes battantes. Nous demandons les cotes du porche, de la cour et de la cabine avant le devis, parce que ces trois mesures déterminent si la livraison se fait en dix minutes ou en trois heures de portage." },
      { t: "Un trajet court, sans formalité", d: "L'Italie étant dans l'Union européenne, aucune formalité douanière n'est requise. La route par l'autoroute des Fleurs longe la Riviera puis remonte vers la plaine du Pô, et se couvre confortablement dans la journée. Cette proximité permet un chargement le matin et une livraison l'après-midi, avec la même équipe de bout en bout et sans nuit intermédiaire. C'est le format que nous recommandons, il coûte moins et réduit les manipulations." },
      { t: "Les restrictions de circulation, à connaître", d: "L'Italie applique des restrictions de circulation aux poids lourds certains jours, notamment les dimanches et jours fériés, avec un calendrier publié à l'avance. Un camion immobilisé une journée à la frontière ou sur une aire coûte cette journée à tout le monde. Nous calons le trajet en fonction de ce calendrier, ce qui explique que certaines dates soient écartées d'emblée quand vous nous les proposez." }
    ],
    etapes: [
      { h: "J-20", t: "Demande d'autorisation d'accès à la zone réglementée, avec les caractéristiques du véhicule." },
      { h: "J-7", t: "Relevé des cotes du porche, de la cour intérieure et de l'ascenseur à l'arrivée." },
      { h: "7 h 00", t: "Chargement à Nice, départ par l'autoroute des Fleurs." },
      { h: "15 h 00", t: "Livraison milanaise, avec accès autorisé et créneau respecté." }
    ],
    erreurs: [
      { t: "Entrer dans la zone sans autorisation", d: "Le contrôle est automatique par caméra et l'amende tombe sans discussion. L'autorisation se demande des semaines avant." },
      { t: "Ignorer la hauteur du porche", d: "Un utilitaire qui ne franchit pas le porche transforme la livraison en portage depuis la rue. Les cotes se demandent avant." },
      { t: "Rouler un dimanche ou un jour férié", d: "Les restrictions italiennes immobilisent le camion une journée entière. Le calendrier est publié, il suffit de le consulter." }
    ]
  },
  ...
  "nice-turin": {
    ...
    sections: [
      { t: "Le franchissement alpin, selon la saison", d: "Le passage vers le Piémont se fait par des itinéraires de montagne dont les conditions varient fortement selon la période. Certains cols peuvent être fermés ou soumis à équipements en hiver, et les contraintes de gabarit et de tonnage diffèrent d'un passage à l'autre. Nous choisissons l'itinéraire en fonction de la saison, du véhicule et des conditions du jour, et nous vérifions l'état des routes la veille du départ. C'est un trajet court en distance et exigeant en préparation, exactement l'inverse de ce qu'on attend." },
      { t: "Une ville en damier, mais réglementée", d: "Turin est bâtie sur un plan régulier avec de larges avenues et des cours intérieures, ce qui facilite considérablement l'approche par rapport aux centres médiévaux. En revanche le centre est également soumis à des restrictions d'accès contrôlées, avec des conditions portant sur le véhicule et les horaires. L'autorisation se demande à l'avance auprès des services municipaux. La facilité de circulation ne dispense donc pas de la démarche administrative, et c'est l'erreur classique sur cette destination." },
      { t: "Les immeubles à cour et leurs porches", d: "Comme à Milan, le bâti turinois s'organise souvent autour de cours intérieures accessibles par un porche dont la hauteur limite l'entrée d'un utilitaire. Les ascenseurs des immeubles anciens sont étroits. Nous demandons les cotes du porche et de la cabine avant le devis. Quand le porche ne passe pas, le portage se fait depuis la rue et cette différence doit figurer au devis plutôt que d'être découverte le jour de la livraison." },
      { t: "Un aller-retour possible dans la journée", d: "La proximité permet, pour des volumes modérés, un chargement le matin à Nice et une livraison l'après-midi à Turin, avec la même équipe de bout en bout et sans nuit intermédiaire. C'est le format le plus économique et le moins risqué, puisque le mobilier n'est déchargé qu'une seule fois. Nous le proposons systématiquement quand le volume et les contraintes d'accès le permettent, et nous le disons quand ce n'est pas réaliste." }
    ],
    etapes: [
      { h: "J-20", t: "Demande d'autorisation d'accès au centre de Turin, avec les caractéristiques du véhicule." },
      { h: "J-1", t: "Vérification de l'état du passage alpin et choix définitif de l'itinéraire." },
      { h: "6 h 30", t: "Chargement à Nice, départ par l'itinéraire retenu selon la saison." },
      { h: "14 h 00", t: "Livraison turinoise, accès à la cour si le porche le permet, sinon portage depuis la rue." }
    ],
    erreurs: [
      { t: "Choisir l'itinéraire sans regarder la saison", d: "Les passages alpins n'ont pas les mêmes conditions en janvier et en juillet. L'itinéraire se décide la veille, pas un mois avant." },
      { t: "Croire qu'une ville facile dispense d'autorisation", d: "Turin est simple à circuler et son centre reste réglementé. L'autorisation se demande comme ailleurs." },
      { t: "Ne pas mesurer le porche", d: "Il décide si le camion entre dans la cour ou si tout se porte depuis la rue. C'est la différence entre une heure et une demi-journée." }
    ]
  }

};

Object.assign(window, { ROUTE_FOND });
