...
const QUARTIERS = {
  ...
  "riquier": {
    ...
    aot: "standard",
    contraintes: [
      { t: "Rues étroites et à sens unique", d: "Le gabarit du camion se choisit en fonction de la rue. Sur certains axes, un porteur standard passe difficilement et la manœuvre de stationnement demande de la place." },
      { t: "Immeubles sans ascenseur", d: "Beaucoup d'immeubles anciens de trois à cinq étages sans ascenseur. Le portage devient le poste principal du chantier, et il se chiffre précisément." },
      { t: "Stationnement rare", d: "Peu de places disponibles, très demandées. La réservation en amont est ce qui évite de porter les meubles sur cinquante mètres." },
      { t: "Proximité du port et de la voie ferrée", d: "Certaines rues subissent des restrictions de circulation liées aux accès portuaires. L'adresse exacte détermine l'itinéraire du camion." }
    ],
    methode: [
      "Repérage de la rue et choix du gabarit adapté avant de fixer le devis.",
      "Réservation d'emplacement au plus près de l'entrée, demandée au moins 5 jours ouvrés avant.",
      "Chiffrage explicite du portage : étages, ascenseur, distance de portage depuis le camion.",
      "Démontage des meubles volumineux quand la cage d'escalier ne permet pas le passage monté."
    ],
    faq: [
      { q: "Le portage à l'étage coûte-t-il plus cher ?", a: "Oui, et c'est normal : c'est du temps et de la main-d'œuvre. Ce qui n'est pas normal, c'est de le découvrir le jour J. Chez nous, le nombre d'étages et la présence d'ascenseur sont dans le devis, et le prix ne bouge pas ensuite." },
      { q: "Que faire si aucune place n'est libre devant chez moi ?", a: "C'est exactement ce que règle l'autorisation d'occupation temporaire : la Ville réserve l'emplacement, la signalisation est posée à l'avance, et la place est libre à votre arrivée. Sans cette démarche, on porte sur la distance disponible." },
      { q: "Un monte-meuble est-il possible à Riquier ?", a: "Dans une partie du quartier oui, à condition d'avoir le recul nécessaire au sol pour déployer l'appareil. Dans les rues les plus étroites, on privilégie le démontage et le portage." }
    ],
...
Object.assign(window, { QUARTIERS, AOT, getQuartier, listeQuartiers });
