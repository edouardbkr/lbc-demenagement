      ...
      <div className="wrap">
        <div className="about-grid">
          <div className="about-copy reveal">
            ...
            <p>Devis conforme aux barèmes, justificatifs complets pour votre remboursement, coordination avec votre date d'affectation et garde-meuble en transition : vous avez une seule chose à faire, rejoindre votre poste. Quelle que soit la formule, du simple transport au clé en main, vous avez des déménageurs expérimentés, une assurance incluse et un interlocuteur unique.</p>
