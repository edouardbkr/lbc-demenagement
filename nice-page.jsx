...
function NicePrix() {
  ...
  return (
    <section className="sec"><div className="wrap">
      ...
      <p className="lede" style={{ marginTop: 20 }}>La formule Luxe, qui comprend l'emballage de vos cartons et la mise en place à l'arrivée, se chiffre après une visio de dix minutes : le contenu des cartons de quelqu'un ne se devine pas de l'extérieur. <a href="Formules" style={{ color: "var(--accent)", fontWeight: 600 }}>Voir le détail des trois formules →</a></p>
