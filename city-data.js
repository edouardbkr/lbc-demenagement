...
const CITIES = {
  ...
  "saint-paul-de-vence": {
    ...
    titre: "Déménagement à Saint-Paul-de-Vence · village classé",
    cp: "06570",
    dept: "Alpes-Maritimes (06)",
    region: "cote",
  ...
  "cap-d-antibes": {
    ...
    titre: "Déménagement au Cap d'Antibes · propriétés gardées",
    cp: "06160",
    dept: "Alpes-Maritimes (06)",
    region: "cote",
  ...
  "valbonne-sophia-antipolis": {
    ...
    specifics: [{
      t: "Déménagement pris en charge par l'employeur",
      d: "Devis au nom de la société, bon de commande, facturation séparée et justificatifs pour le service des ressources humaines. Nous traitons directement avec le service mobilité quand le salarié n'est pas encore arrivé."
    }, {
      t: "Date imposée par la prise de poste",
      d: "Un premier jour de travail ne se décale pas. Nous partons de cette date et remontons le calendrier, quitte à livrer avant que le salarié n'ait fini son préavis dans son ancien logement."
    }, {
      t: "Résidences du parc, accès contrôlés",
      d: "Les résidences de Garbejaire et des Bouillides ont des barrières, des places visiteurs limitées et des règlements d'immeuble. Nous prévenons le syndic et réservons l'accès avant le jour du déménagement."
    }],
    deep: [{
      t: "Le calendrier part de la prise de poste, pas du bail",
      p: "Chez un particulier, on cale le déménagement sur la remise des clés. Ici, le point fixe est la date d'entrée en fonction, et tout le reste s'y adapte. Il arrive qu'un salarié prenne son poste au technopôle trois semaines avant que sa famille n'emménage : on charge, on stocke le temps nécessaire, et on livre quand le logement est disponible. Cette souplesse-là se décide au devis, pas la veille, parce qu'elle mobilise un camion et un volume de stockage sur une période précise."
    }, {
      t: "Facturer une entreprise n'est pas facturer un particulier",
      p: "Quand la mobilité est prise en charge, l'employeur veut un devis détaillé au nom de la société, un numéro de bon de commande reporté sur la facture et parfois une note distinguant ce qui relève de la prestation et ce qui relève des fournitures. Nous préparons ces pièces dès le devis, avec le montant de l'assurance indiqué noir sur blanc, parce que c'est la ligne que les services de mobilité vérifient en premier. Un dossier incomplet retarde le remboursement du salarié de plusieurs semaines."
    }, {
      t: "Coordonner à distance, sans chiffrer à l'aveugle",
      p: "Beaucoup de nos clients n'ont pas encore vu leur futur logement, et certains sont à l'étranger. Nous faisons le repérage de l'adresse d'arrivée à leur place : largeur d'accès, stationnement, ascenseur et dimensions de la cage d'escalier, transmis avec des photos. C'est ce qui distingue une entreprise de déménagement à Valbonne Sophia Antipolis d'un devis fait au téléphone : personne ne découvre le jour de la livraison que le canapé ne passe pas la porte."
    }, {
      t: "Le village et les hameaux, l'autre Valbonne",
      p: "À trois kilomètres du parc, le village de Valbonne est un damier de rues étroites du seizième siècle, avec une place centrale interdite aux véhicules les jours de marché. Les maisons de village y ont des escaliers droits et des paliers courts, et le camion se gare aux abords. Rien à voir avec les résidences du technopôle et leurs parkings dimensionnés pour des cadres motorisés. Nous demandons donc systématiquement l'adresse exacte avant de chiffrer : sur cette commune, deux points distants de quelques minutes n'ont pas le même prix."
    }],
    faq: [{
      q: "Travaillez-vous avec les entreprises de Sophia Antipolis ?",
      a: "Oui, régulièrement. Devis au nom de la société, bon de commande et facturation séparée. Un déménagement à Valbonne Sophia Antipolis pris en charge par l'employeur se prépare avec le service mobilité, même si le salarié n'est pas encore sur place."
    }, {
      q: "Pouvez-vous stocker entre le chargement et la livraison ?",
      a: "Oui. C'est fréquent quand la prise de poste précède la disponibilité du logement. Le volume et la durée se calent au devis, pas au dernier moment."
    }, {
      q: "Le salarié doit-il être présent le jour du déménagement ?",
      a: "Non, à condition d'avoir désigné une personne de confiance et de nous avoir remis les clés. Nous transmettons un état des lieux photographique au chargement et à la livraison."
    }, {
      q: "Faut-il prévenir la résidence à Garbejaire ou aux Bouillides ?",
      a: "Oui. Barrière, places visiteurs et créneaux d'accès sont réglementés. Nous contactons le syndic une semaine avant pour réserver l'emplacement."
    }, {
      q: "Déménagez-vous aussi dans le village de Valbonne ?",
      a: "Bien sûr. Les rues y sont étroites et la place centrale est occupée les jours de marché : le camion stationne aux abords et le portage est plus long qu'au technopôle."
    }, {
      q: "Le devis peut-il changer si l'entreprise modifie la date ?",
      a: "Le prix reste ferme. Seul un report très tardif en pleine saison peut affecter la disponibilité, et votre déménageur à Valbonne Sophia Antipolis vous le dit avant, jamais après."
    }],
    nearby: ["antibes", "grasse", "le-cannet", "villeneuve-loubet", "cagnes-sur-mer"]
  },
  "vence": {
    name: "Vence",
    file: "Demenagement-Vence",
    cp: "06140",
    dept: "Alpes-Maritimes (06)",
    region: "cote",
    ...
    specifics: [{
      t: "Cité historique fermée aux camions",
      d: "Les cinq portes de l'enceinte médiévale n'admettent aucun véhicule de déménagement. Le camion se poste au plus près et le portage se fait par les ruelles, jusqu'à deux cents mètres selon la porte."
    }, {
      t: "Villas avec dépendances",
      d: "Pool house, atelier, cave, garage double : le volume réel dépasse presque toujours l'estimation faite sur la seule surface habitable. Nous comptons les annexes avant de chiffrer."
    }, {
      t: "Mobilier ancien et pièces lourdes",
      d: "Armoires provençales, buffets en noyer, tables monastère : des meubles massifs qui se démontent rarement et passent difficilement les portes anciennes. Protection sur mesure et équipe renforcée."
    }],
    deep: [{
      t: "Sortir un logement de la vieille ville",
      p: "Les rues de la cité sont larges d'un mètre cinquante à trois mètres et pavées, avec des seuils surélevés et des passages voûtés bas. Un déménagement s'y organise autour de la porte la plus proche : Porte du Peyra, Porte du Signadou ou Porte de l'Orient, chacune donnant sur une possibilité de stationnement différente. Nous repérons ce trajet avant de chiffrer et nous comptons la distance réelle de portage, parce que c'est elle, et non le volume, qui fixe le nombre d'équipiers et la durée de la journée."
    }, {
      ...
      t: "Le mobilier ancien, et pourquoi il change la méthode",
      p: "Vence attire depuis longtemps une clientèle installée, et le mobilier suit : armoires à corniche, secrétaires, commodes en bois massif, parfois des pièces d'atelier héritées. Ces meubles ne se démontent pas comme du mobilier contemporain, leurs assemblages travaillent, et une armoire provençale pèse couramment cent vingt kilos à vide. On les sangle debout, on protège les arêtes et les pieds, et on prévoit le passage par une fenêtre quand l'escalier tourne trop court. C'est plus lent, et c'est prévu au devis."
    }, {
      t: "Les chemins de colline et le gabarit du camion",
      p: "Au Riou, aux Baous ou du côté de Passeprest, les villas se rejoignent par des chemins privés en montée, bordés de murets et terminés par un portail de trois mètres. Un porteur de vingt mètres cubes n'y entre pas toujours. Nous repérons le dernier virage avant d'engager un véhicule : c'est ce qu'on attend d'un déménageur à Vence plutôt que d'un transporteur de passage, et cela évite la marche arrière sur cinq cents mètres."
    }],
    faq: [{
      q: "Le camion peut-il entrer dans la vieille ville de Vence ?",
      a: "Non. Les portes de l'enceinte médiévale ne laissent pas passer un véhicule de déménagement. Le camion se poste au plus près et le mobilier sort à la main par les ruelles."
    }, {
      q: "Quelle distance de portage faut-il prévoir dans la cité ?",
      a: "De cinquante à deux cents mètres selon la porte la plus proche et les possibilités de stationnement. Nous mesurons ce trajet avant de chiffrer."
    }, {
      q: "Comptez-vous le garage et le pool house dans le volume ?",
      a: "Oui, systématiquement. Les dépendances représentent souvent dix à quinze mètres cubes qu'une estimation faite sur la surface habitable ignore complètement."
    }, {
      q: "Comment transportez-vous une armoire provençale ?",
      a: "Sanglée debout, arêtes et pieds protégés, portée par quatre. Quand l'escalier tourne trop court, nous sortons par une fenêtre plutôt que de forcer un assemblage ancien."
    }, {
      q: "Vos camions accèdent-ils aux villas des collines ?",
      a: "Après repérage du dernier virage et du portail. Si le gabarit ne passe pas, nous chargeons en deux rotations avec un utilitaire, ce qui revient moins cher qu'un camion immobilisé."
    }, {
      q: "Faut-il une autorisation de stationnement à Vence ?",
      a: "Oui dès que le camion occupe la voie publique, ce qui est presque toujours le cas aux abords de la cité. Toute entreprise de déménagement à Vence doit la demander en mairie : nous nous en chargeons."
    }],
    nearby: ["cagnes-sur-mer", "saint-laurent-du-var", "grasse", "villeneuve-loubet", "nice"]
  },
  "saint-tropez": {
    name: "Saint-Tropez",
    file: "Demenagement-Saint-Tropez",
    cp: "83990",
    dept: "Var (83)",
    region: "cote",
    ...
    specifics: [{
      t: "Saisonnalité qui commande tout",
      d: "D'octobre à mai, une journée normale. De juin à septembre, accès saturé et stationnement quasi impossible au centre : nous chiffrons en conséquence et proposons de décaler quand la date n'est pas contrainte."
    }, {
      t: "Résidences secondaires sans propriétaire",
      d: "Inventaire photographique au chargement et à la livraison, coordination avec le gardien ou la conciergerie, remise de clés tracée. Le propriétaire suit à distance."
    }, {
      t: "Distance intégrée au devis, pas ajoutée après",
      d: "Cent dix kilomètres depuis notre base niçoise : le trajet est chiffré dès le départ. C'est le poste que les devis à distance oublient et qui réapparaît en supplément le jour J."
    }],
    deep: [{
      t: "Pourquoi nous poussons à déménager hors saison",
      p: "L'accès à la presqu'île se fait par une route unique, et de la mi-juin à la fin août elle est régulièrement bloquée plusieurs heures. Un camion qui arrive à midi au lieu de huit heures perd la journée, et le portage se fait alors dans une circulation où le moindre arrêt crée un bouchon. Hors saison, le même chantier se traite sans stress, avec un stationnement disponible et une équipe qui rentre le soir. Quand la date est libre, nous conseillons octobre à mai, et cela se voit sur le devis : la même prestation en pleine saison mobilise plus longtemps le camion et l'équipe."
    }, {
      t: "Déménager une maison dont le propriétaire est absent",
      p: "Beaucoup de biens tropéziens sont des résidences secondaires. Le propriétaire vit ailleurs, parfois à l'étranger, et confie les clés à un gardien, une conciergerie ou une agence. Nous travaillons alors sur inventaire : chaque pièce est photographiée avant le chargement, les objets fragiles sont listés, et le même relevé est refait à la livraison. Ce n'est pas une formalité. Sur un intérieur meublé avec soin, où le propriétaire ne verra le résultat que des semaines plus tard, c'est la seule façon de lever tout doute sur ce qui est parti dans quel état."
    }, {
      t: "Les Parcs et les domaines fermés",
      p: "Le domaine des Parcs fonctionne avec un poste de garde, une liste d'accès déposée à l'avance et des règles de circulation intérieures. On n'y entre pas en annonçant qu'on vient déménager au numéro douze. Une entreprise de déménagement à Saint-Tropez transmet donc les immatriculations et l'identité des équipiers plusieurs jours avant, et respecte les horaires autorisés, qui excluent souvent le début de matinée."
    }, {
      t: "Le mobilier de bord de mer, et ce qu'il impose",
      p: "Les intérieurs tropéziens mêlent souvent du mobilier de valeur, des œuvres accrochées et du mobilier d'extérieur volumineux : grandes tables, transats, parasols déportés lestés. Les toiles et objets d'art partent en caisse ou en emballage renforcé, et se déclarent séparément pour l'assurance. Le mobilier de jardin, lui, occupe un volume que personne n'annonce spontanément : un salon d'extérieur complet et deux bains de soleil représentent facilement six mètres cubes. Nous les comptons à la visite."
    }],
    faq: [{
      q: "Intervenez-vous à Saint-Tropez en plein été ?",
      a: "Oui, mais nous le déconseillons quand la date est libre. Un déménagement à Saint-Tropez en août dépend d'une route unique, régulièrement bloquée : une journée entière peut se perdre en attente."
    }, {
      q: "Le trajet depuis Nice est-il facturé en supplément ?",
      a: "Non. Les cent dix kilomètres sont intégrés au devis dès le départ. Aucun frais de route n'apparaît le jour du déménagement."
    }, {
      q: "Faut-il que je sois présent le jour du déménagement ?",
      a: "Non. Nous travaillons couramment avec un gardien ou une conciergerie, sur inventaire photographique au chargement et à la livraison."
    }, {
      q: "Comment accède-t-on aux Parcs de Saint-Tropez ?",
      a: "Sur liste déposée à l'avance au poste de garde, avec les immatriculations et l'identité des équipiers, et dans les créneaux horaires autorisés par le domaine."
    }, {
      q: "Prenez-vous en charge les œuvres d'art ?",
      a: "Oui, en caisse ou emballage renforcé selon la pièce. Elles se déclarent séparément pour être couvertes à leur valeur réelle."
    }, {
      q: "Le mobilier de jardin compte-t-il dans le volume ?",
      a: "Oui, et il pèse plus que prévu : un salon d'extérieur avec bains de soleil atteint facilement six mètres cubes. Votre déménageur à Saint-Tropez doit le compter pendant la visite, pas le matin du chargement."
    }],
    nearby: ["cannes", "mandelieu", "grasse", "antibes", "le-cannet"]
  },
  "mougins": {
    name: "Mougins",
    file: "Demenagement-Mougins",
    cp: "06250",
    dept: "Alpes-Maritimes (06)",
    region: "cote",
    ...
    specifics: [{
      t: "Vieux village entièrement piéton",
      d: "Aucun véhicule dans les ruelles du village. Chargement au parking et portage par la rampe en colimaçon, avec une équipe renforcée et un chiffrage à la distance réelle."
    }, {
      t: "Domaines fermés et gardiennés",
      d: "Portail, poste de garde, liste d'accès à déposer et horaires imposés par le règlement intérieur. Nous transmettons immatriculations et identités plusieurs jours avant."
    }, {
      t: "Villas avec piscine et dépendances",
      d: "Pool house, local technique, garage et abri de jardin s'ajoutent au volume habitable. Nous les comptons à la visite plutôt que de les découvrir le matin du chargement."
    }],
    deep: [{
      t: "Le village, une spirale qui se monte à pied",
      p: "Le vieux Mougins s'enroule autour de sa butte en une rampe pavée que les véhicules ne franchissent pas. Depuis le parking, il faut compter entre cent et deux cent cinquante mètres de montée selon la maison, sur des pavés irréguliers et par des passages qui se resserrent à un mètre vingt. Un canapé trois places n'y passe pas horizontalement dans certains angles : il se sort debout, parfois par une fenêtre. Nous montons repérer le trajet et mesurer les points étroits avant d'annoncer un prix, et nous prévoyons deux équipiers de plus qu'ailleurs pour un volume équivalent."
    }, {
      t: "Entrer dans un domaine privé, ça se prépare",
      ...
      t: "Les allées privées et le gabarit réel",
      ...
      t: "Ce que cachent les dépendances",
      p: "Sur les villas avec piscine, le volume réel dépasse presque toujours ce que le propriétaire annonce. Le pool house contient du mobilier d'extérieur, le local technique de l'outillage, le garage des vélos et des cartons oubliés : quinze mètres cubes à eux trois, couramment. Une entreprise de déménagement à Mougins qui veut tenir son prix ouvre donc toutes les portes pendant la visite, y compris celles dont on lui assure qu'elles sont vides."
    }],
    faq: [{
      q: "Le camion peut-il monter dans le vieux village de Mougins ?",
      a: "Non, les ruelles sont piétonnes. Le chargement se fait au parking et le mobilier monte à pied par la rampe pavée, sur cent à deux cent cinquante mètres."
    }, {
      q: "Comment sortez-vous un canapé d'une maison de village ?",
      a: "Debout, et par une fenêtre quand un angle se resserre sous un mètre vingt. Nous repérons les points étroits avant de chiffrer pour ne pas improviser le jour même."
    }, {
      q: "Que faut-il pour entrer dans un domaine gardé ?",
      a: "Une liste d'accès déposée à l'avance avec les immatriculations et l'identité des équipiers, et le respect des horaires du règlement intérieur, souvent de huit à dix-huit heures."
    }, {
      q: "Vos camions passent-ils les allées privées ?",
      a: "Après mesure du portail et de l'aire de retournement. Si le gabarit ne passe pas, nous faisons la navette en utilitaire depuis le camion resté en bas."
    }, {
      q: "Le pool house et le garage sont-ils comptés ?",
      a: "Oui. Ces annexes représentent souvent quinze mètres cubes à elles seules. Nous les ouvrons toutes pendant la visite pour que le prix tienne."
    }, {
      q: "Peut-on déménager un piano au village ?",
      a: "Oui, avec un équipement spécifique et une équipe dédiée. La rampe pavée impose un portage lent : votre déménageur à Mougins le chiffre à part et l'annonce avant, jamais le jour J."
    }],
