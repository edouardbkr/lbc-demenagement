      ...
      <div className="wrap">
        <div className="about-grid">
          <div className="about-copy reveal">
            ...
            <p>
              Quelle que soit la formule — <strong style={{ color: 'var(--ink)' }}>Standard, Premium ou Luxe</strong> — des déménageurs expérimentés et soigneux, une assurance complète et un devis clair et définitif. {r.intl ? "À l'international comme en France, " : ""}chaque poste est détaillé au devis, et ce devis est définitif.
            </p>
