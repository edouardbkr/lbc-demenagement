/* route-data.jsx — compilé par build.js, ne pas éditer */
(function () {
const ROUTES = {
  "nice-paris": {
    from: "Nice",
    ...
    points: [{
      t: "Stationnement parisien",
      d: "Autorisation d'occupation de voirie demandée en amont auprès de la Ville de Paris, emplacement réservé devant l'immeuble pour ne pas perdre une heure le jour J."
    }, {
      t: "Immeubles haussmanniens",
      d: "Étages élevés sans ascenseur, cages d'escalier en colimaçon, cours étroites : on prévoit le monte-meuble par la façade dès le devis, jamais en surprise."
    }, {
      t: "Trajet direct et plombé",
      d: "Camion dédié à votre seul chargement, scellé au départ de Nice et livré en une traite, avec une fenêtre d'arrivée annoncée et tenue."
    }],
    deep: [{
      t: "Paris, le vrai défi est à l'arrivée",
      p: "Sur un Nice–Paris, la route est la partie facile. Le casse-tête, c'est l'arrivée parisienne : immeubles haussmanniens aux escaliers en colimaçon, derniers étages sans ascenseur, cours intérieures où le camion ne rentre pas, et un stationnement réglementé partout. On repère l'adresse en amont, on demande l'autorisation de voirie et on prévoit le monte-meuble par la façade quand l'escalier ne passe pas. Tout est chiffré au devis, pour qu'aucune contrainte parisienne ne devienne un supplément le jour même."
    }, {
      t: "Intra-muros ou couronne, on connaît",
      p: "Que vous arriviez dans un studio du Marais, un familial du 15e, un appartement de Boulogne ou une maison de banlieue, la logistique change. Paris intra-muros impose des créneaux, des rues étroites et des stationnements minutés ; la proche couronne offre plus de place mais des trajets de portage parfois longs. On adapte le véhicule (un gros porteur ne rentre pas partout dans Paris) et on transborde avec un utilitaire plus maniable quand l'adresse l'exige."
    }, {
    ...
    faq: [{
      ...
      a: "Le transport représente une journée de route (≈ 930 km). On charge un jour, on livre dans la foulée selon une fenêtre d'arrivée annoncée et tenue, sans attente en entrepôt."
    }, {
      q: "Gérez-vous le monte-meuble à Paris ?",
      a: "Oui, et c'est souvent indispensable dans les immeubles haussmanniens à escaliers étroits. Il est repéré et chiffré dès le devis, jamais ajouté en surprise le jour J."
    }, {
      q: "Faites-vous du groupage ou un camion dédié ?",
      a: "Un camion dédié à votre seul chargement, plombé au départ de Nice. Pas de groupage, pas de transbordement, pas de cartons mélangés à ceux d'un autre client."
    }, {
      q: "Gérez-vous le stationnement à Paris ?",
  ...
  "nice-lyon": {
    ...
    points: [{
      t: "Pentes et traboules",
      d: "Portage adapté aux immeubles anciens de la Croix-Rousse et aux accès étroits du Vieux Lyon, avec monte-meuble quand l'escalier Renaissance ne passe pas."
    }, {
      t: "Demi-journée de route",
      d: "≈ 470 km : chargement le matin à Nice, livraison possible dès le lendemain à Lyon, sans attente en entrepôt."
    }, {
      t: "Presqu'île dense",
      d: "Stationnement réservé et créneaux maîtrisés dans l'hypercentre lyonnais, entre Bellecour, les Terreaux et la Confluence."
    }],
    deep: [{
      t: "La ville aux deux collines",
      p: "Lyon ne se déménage pas à plat. La Croix-Rousse, ancien quartier des canuts, grimpe par des pentes raides et des immeubles hauts à escaliers étroits, souvent sans ascenseur. Fourvière domine le Vieux Lyon. Entre les deux, la Presqu'île concentre l'hypercentre. On repère à quel étage et dans quel type d'immeuble vous arrivez, et on prévoit portage, véhicule relais ou monte-meuble selon la colline et la cage d'escalier."
    }, {
      t: "Vieux Lyon, traboules et Renaissance",
      p: "Classé au patrimoine mondial, le Vieux Lyon est un dédale d'immeubles Renaissance, de cours intérieures et de traboules, ces passages traversants typiquement lyonnais. Les cages d'escalier y sont étroites et anciennes, les rues parfois piétonnes. Déménager ici demande méthode et délicatesse : portage soigné, stationnement réservé au plus près et monte-meuble pour les volumes qui ne passent pas par l'escalier en vis."
    }, {
      t: "Une métropole étudiante et professionnelle",
      p: "Lyon est l'une des premières villes étudiantes et économiques de France : beaucoup de nos Nice–Lyon sont des mutations professionnelles, des installations d'étudiants ou de jeunes actifs. Pour les mutations, on fournit un devis conforme à transmettre à l'employeur et une facture en règle. Studio à la Guillotière, familial à la Confluence ou aux Brotteaux : on s'adapte au volume comme au quartier."
    }, {
      t: "Un trajet court pour une longue distance",
      p: "À ≈ 470 km, Lyon est à mi-chemin : un trajet assez court pour qu'un déménagement reste fluide et économique, livraison souvent possible dès le lendemain du chargement. Camion dédié et plombé, une seule équipe du départ à l'arrivée, pas de groupage ni de transbordement. Et si vos dates de départ et d'arrivée ne coïncident pas, on propose un garde-meuble relais en box sécurisé."
    }],
    faq: [{
      q: "En combien de temps livrez-vous à Lyon ?",
      a: "Le trajet fait ≈ 470 km, soit une demi-journée de route. Chargement à Nice, livraison souvent possible dès le lendemain, avec une fenêtre annoncée au devis."
    }, {
      q: "Gérez-vous les traboules et la Croix-Rousse ?",
      a: "Oui : portage adapté aux pentes et aux immeubles anciens, et monte-meuble pour les cages d'escalier Renaissance trop étroites. Tout est anticipé au devis."
    }, {
      q: "Et le stationnement en Presqu'île ?",
      a: "On réserve l'emplacement au plus près et on gère les créneaux de l'hypercentre lyonnais, souvent contraint entre Bellecour et les Terreaux."
    }, {
      q: "Gérez-vous les mutations professionnelles vers Lyon ?",
      a: "Oui, fréquent sur ce trajet : devis conforme pour votre employeur, facture en règle pour le remboursement, coordination avec votre prise de poste."
    }, {
      q: "Faites-vous un camion dédié ou du groupage ?",
      a: "Un camion dédié à votre seul chargement, plombé au départ. Pas de groupage, pas de transbordement, une seule équipe jusqu'à Lyon."
    }]
  },
  "nice-marseille": {
    from: "Nice",
    ...
    deep: [{
      ...
      t: "Étudiants, actifs et mutations",
      p: "Avec ses universités, son port et son tissu économique, Marseille attire étudiants, jeunes actifs et mutations professionnelles. On déménage aussi bien un studio d'étudiant près de Saint-Charles qu'un appartement familial à Castellane ou un transfert lié à une prise de poste. Pour les mutations, devis conforme et facture en règle. La proximité permet aussi les déménagements en plusieurs voyages quand c'est plus simple pour vous."
    }],
    faq: [{
      q: "Un déménagement Nice–Marseille, c'est rapide ?",
      a: "Oui, ≈ 2 h de route seulement : chargement et livraison sont souvent réalisables dans la même journée selon le volume et les accès."
    }, {
      q: "Gérez-vous le centre de Marseille et le Panier ?",
      a: "Oui : stationnement réservé et portage adaptés aux ruelles en pente du Panier et à l'hypercentre dense autour du Vieux-Port."
    }, {
      q: "Les petits volumes sont-ils acceptés ?",
      a: "Bien sûr, et c'est même là que le trajet brille : la distance courte rend un studio ou un petit volume économique à déménager."
    }, {
      q: "Faites-vous les mutations professionnelles vers Marseille ?",
      a: "Oui : devis conforme pour votre employeur et facture en règle, en plus des déménagements de particuliers et d'étudiants."
    }, {
      q: "Le devis inclut-il le transport jusqu'à Marseille ?",
      a: "Oui, tout est compris et ferme : transport, équipe, protection. Aucun supplément kilométrique surprise sur la facture."
    }]
  },
  "nice-toulouse": {
    from: "Nice",
    ...
    points: [{
      t: "Centre en brique",
      d: "Stationnement et portage du Capitole, des Carmes et de Saint-Cyprien gérés en amont, dans des rues étroites où le camion ne passe pas toujours."
    }, {
      t: "Une seule équipe",
      d: "Les mêmes déménageurs sur les ≈ 560 km, du chargement à Nice à la livraison à Toulouse, sans transbordement ni groupage."
    }, {
      t: "Trajet optimisé",
      d: "Itinéraire et planning calés pour tenir la fenêtre de livraison annoncée au devis, à l'heure dite."
    }],
    deep: [{
      t: "La ville rose, brique et rues étroites",
      p: "Toulouse se reconnaît à sa brique foraine et à son centre historique compact. Autour du Capitole, dans le quartier des Carmes ou à Saint-Cyprien sur l'autre rive de la Garonne, les rues sont étroites, parfois piétonnes, et les immeubles anciens ont des cages d'escalier exiguës. On stationne au plus près, on gère le portage et on prévoit un monte-meuble quand le mobilier ne passe pas, comme partout où le bâti ancien complique l'accès."
    }, {
      t: "Une métropole en pleine expansion",
      p: "Portée par l'aéronautique et le spatial, Toulouse est l'une des villes les plus dynamiques de France et accueille des milliers de nouveaux arrivants chaque année. Beaucoup de nos Nice–Toulouse sont des mutations professionnelles, notamment dans l'industrie. On fournit un devis conforme pour l'employeur, une facture en règle, et on coordonne le déménagement avec votre date de prise de poste."
    }, {
      t: "Du centre aux quartiers résidentiels",
      p: "Au-delà de l'hypercentre, Toulouse s'étend largement : quartiers résidentiels de Rangueil et de Côte Pavée, secteurs étudiants vers l'université, communes de la périphérie. Ces adresses sont généralement plus simples d'accès, avec parking et ascenseur, ce qui fluidifie le déménagement. On adapte le gabarit du camion à chaque cas, du gros porteur en périphérie au véhicule plus maniable en centre-ville."
    }, {
      t: "Une longue distance maîtrisée",
    ...
    faq: [{
      q: "Combien de temps pour un Nice–Toulouse ?",
      a: "≈ 560 km, soit une bonne journée de route. La fenêtre de livraison est annoncée au devis et tenue, sans attente en entrepôt."
    }, {
      q: "Gérez-vous le centre historique toulousain ?",
      a: "Oui : stationnement réservé et portage adaptés aux rues étroites du centre en brique, autour du Capitole et des Carmes, avec monte-meuble si besoin."
    }, {
      q: "Faites-vous les mutations dans l'aéronautique ?",
      a: "Oui, c'est fréquent sur ce trajet : devis conforme pour votre employeur, facture en règle et coordination avec votre prise de poste."
    }, {
      q: "Le devis inclut-il le transport ?",
  ...
  "nice-bordeaux": {
    ...
    points: [{
      t: "Grande distance maîtrisée",
      d: "≈ 800 km : itinéraire optimisé, camion dédié et plombé, fenêtre de livraison annoncée et tenue."
    }, {
      t: "Échoppes et centre classé",
      d: "Accès aux maisons de ville bordelaises, rues étroites des Chartrons et de Saint-Michel et centre du XVIIIe anticipés dès le devis."
    }, {
      t: "Protection longue route",
      d: "Calage et arrimage renforcés : sur 800 km, rien ne bouge dans le camion, votre mobilier arrive comme il est parti."
    }],
    deep: [{
      t: "Bordeaux et ses échoppes",
      p: "L'échoppe bordelaise est une particularité locale : une maison de ville basse, en pierre, souvent étroite et tout en longueur, typique des Chartrons, de Saint-Michel ou de la Bastide. Pas d'ascenseur, des couloirs parfois resserrés, une porte qui donne directement sur la rue : le déménagement s'y fait au portage soigné, avec un véhicule bien dimensionné stationné au plus près. On connaît ce bâti et on adapte la méthode plutôt que de forcer."
    }, {
      t: "Un centre classé, des rues contraintes",
      p: "Le centre du XVIIIe siècle de Bordeaux est classé au patrimoine mondial : immeubles en pierre blonde, rues étroites, secteurs piétons et stationnement très réglementé autour des quais, de la place de la Bourse et des Quinconces. On réserve l'emplacement camion en amont, on gère les créneaux et on prévoit le monte-meuble pour les étages des immeubles anciens, fréquents dans l'hypercentre bordelais."
    }, {
      t: "Une ville qui attire",
      p: "Devenue l'une des destinations préférées des actifs et des familles, Bordeaux accueille beaucoup d'arrivants venus du sud-est. Mutations professionnelles, changements de vie, retours en région : nos Nice–Bordeaux couvrent tous ces profils. Pour les mutations, on remet un devis conforme à l'employeur et une facture en règle. Du studio du centre à la maison de la périphérie, on dimensionne l'équipe et le camion au volume."
    }, {
    ...
    faq: [{
      q: "Combien de jours pour un Nice–Bordeaux ?",
      a: "Le transport demande une journée complète (≈ 800 km). On annonce une fenêtre de livraison précise au devis et on la tient, sans attente en entrepôt."
    }, {
      q: "Gérez-vous les échoppes bordelaises ?",
      a: "Oui : ces maisons de ville basses et étroites se déménagent au portage soigné, avec un véhicule stationné au plus près. C'est anticipé dès le devis."
    }, {
      q: "Et le centre classé au stationnement réglementé ?",
      a: "On réserve l'emplacement camion en amont, on gère les créneaux et on prévoit le monte-meuble pour les étages des immeubles anciens."
    }, {
      q: "Mon mobilier est-il bien protégé sur 800 km ?",
  ...
  "nice-geneve": {
    ...
    points: [{
      t: "Formalités douanières",
      d: "Inventaire détaillé et valorisé pour la douane suisse, documents de mobilier de déménagement préparés pour un passage de frontière fluide."
    }, {
      t: "Trajet transalpin direct",
      d: "≈ 470 km via la vallée du Rhône : camion dédié et plombé, mobilier protégé tout du long, une seule équipe."
    }, {
      t: "Accès genevois",
      d: "Stationnement et créneaux des immeubles du centre, des Eaux-Vives ou de Champel, et des résidences internationales, gérés en amont."
    }],
    deep: [{
      t: "La frontière, ce qui change vraiment",
      ...
      t: "Genève, ville internationale et chère du m²",
      p: "Genève est dense, internationale et au foncier tendu : beaucoup d'appartements, des immeubles aux ascenseurs parfois étroits, un stationnement contraint et des résidences à créneaux. Autour des Eaux-Vives, de Champel ou du centre, on réserve l'emplacement et on coordonne avec les régies. La clientèle genevoise inclut fonctionnaires d'organisations internationales et expatriés, habitués à des standards d'organisation élevés qu'on respecte."
    }, {
      t: "Expatriés et fonctionnaires internationaux",
      p: "Une bonne partie des Nice–Genève concerne des expatriations et des prises de poste, souvent dans les organisations internationales ou le secteur bancaire. On fournit un devis conforme à transmettre à votre employeur ou service RH, une facture en règle, et on coordonne le déménagement avec votre calendrier de prise de fonction. L'inventaire valorisé sert aussi de base à votre dossier d'installation et d'assurance."
    }, {
      t: "Un trajet court, un prix ferme",
      p: "À ≈ 470 km par la vallée du Rhône, Genève est l'une de nos destinations internationales les plus proches : le trajet reste fluide et le déménagement maîtrisé. Camion dédié, une seule équipe du chargement à la livraison, mobilier protégé tout du long. Et malgré la frontière, le devis est détaillé et définitif, formalités comprises : pas de mauvaise surprise au passage de la douane."
    }],
    faq: [{
      q: "Quelles formalités pour déménager en Suisse ?",
      a: "Un inventaire détaillé et valorisé de vos biens et un formulaire douanier de mobilier de déménagement. On prépare ces documents avec vous et on vous guide pas à pas."
    }, {
      q: "Combien de temps dure le trajet Nice–Genève ?",
      a: "≈ 470 km, soit une demi-journée à une journée selon le passage de frontière et le déchargement. On annonce une fenêtre au devis."
    }, {
      q: "Gérez-vous les expatriés et fonctionnaires internationaux ?",
      a: "Oui, c'est fréquent à Genève : devis conforme pour votre employeur, facture en règle et coordination avec votre prise de poste."
    }, {
      q: "Le prix est-il ferme malgré la douane ?",
  ...
  "nice-lausanne": {
    ...
    points: [{
      t: "Douane et inventaire",
      d: "Documents douaniers et inventaire valorisé préparés pour l'entrée en Suisse, expliqués et remplis avec vous en amont."
    }, {
      t: "Ville en pente",
      d: "Lausanne grimpe du lac à la colline : portage adapté et monte-meuble pour les immeubles en fort dénivelé, anticipés au devis."
    }, {
      t: "Camion dédié",
      d: "≈ 530 km parcourus par une seule équipe, camion plombé, sans transbordement ni groupage en entrepôt."
    }],
    deep: [{
      t: "Une ville verticale",
      p: "Lausanne est bâtie sur trois collines et descend en pente jusqu'au lac : du quartier d'Ouchy au bord de l'eau jusqu'aux hauteurs de la Sallaz, le dénivelé est partout. Beaucoup d'immeubles ont des accès en pente, des escaliers et des cages anciennes. On repère l'adresse pour prévoir le portage, un véhicule relais ou un monte-meuble, parce qu'à Lausanne, l'accès est souvent plus complexe que le trajet lui-même."
    }, {
      t: "La frontière suisse, bien préparée",
      ...
      t: "Étudiants, chercheurs et expatriés",
      p: "Avec l'EPFL, l'université et un fort tissu international, Lausanne attire étudiants, chercheurs et cadres expatriés. Nos Nice–Lausanne sont souvent liés à une mutation, une thèse ou une prise de poste. On remet un devis conforme pour l'employeur ou l'institution, une facture en règle, et on coordonne avec votre calendrier. Du studio meublé à l'appartement familial, on adapte l'équipe au volume."
    }, {
      t: "Bord du Léman, un trajet direct",
      p: "À ≈ 530 km, Lausanne reste une destination internationale accessible. Camion dédié et plombé, une seule équipe du chargement à la livraison, mobilier protégé sur toute la route. Pas de groupage : vos affaires ne patientent pas en entrepôt. Et si votre logement lausannois n'est pas prêt à temps, on propose un garde-meuble relais en box sécurisé, à Nice ou à l'arrivée."
    }],
    faq: [{
      q: "Faut-il des papiers pour la Suisse ?",
      a: "Oui : un inventaire valorisé de vos biens et un formulaire douanier de mobilier de déménagement, qu'on prépare avec vous avant le départ."
    }, {
      q: "Lausanne est en pente, est-ce un problème ?",
      a: "Non, on prévoit portage, véhicule relais et monte-meuble adaptés au dénivelé dès le devis. C'est l'une des particularités qu'on maîtrise sur cette ville."
    }, {
      q: "Le prix est-il ferme malgré la frontière ?",
      a: "Oui, le devis est détaillé et définitif, formalités comprises. Aucun surcoût n'apparaît au passage de la douane."
    }, {
      q: "Gérez-vous les mutations et installations académiques ?",
      a: "Oui : devis conforme pour votre employeur ou institution, facture en règle, coordination avec votre prise de poste ou votre rentrée."
    }, {
      q: "Combien de temps dure le trajet ?",
      a: "≈ 530 km, soit une demi-journée à une journée selon le passage de frontière et le déchargement à Lausanne."
    }]
  },
  "nice-bruxelles": {
    from: "Nice",
    ...
    points: [{
      t: "Longue distance européenne",
      d: "≈ 1 150 km : trajet planifié, camion dédié et plombé, mobilier arrimé pour la longue route, fenêtre de livraison annoncée."
    }, {
      t: "Maisons bruxelloises",
      d: "Escaliers raides et étroits typiques des maisons de maître belges : monte-meuble prévu dès le devis pour les volumes."
    }, {
      t: "Union européenne",
      d: "Pas de douane : un inventaire détaillé suffit. On gère toute la logistique de la traversée, sans paperasse douanière."
    }],
    deep: [{
      t: "Les maisons bruxelloises, le vrai défi",
      p: "Bruxelles est une ville de maisons de ville étroites et hautes, sur trois ou quatre niveaux, avec des escaliers raides, étroits et souvent en colimaçon : un classique belge qui complique tout déménagement. Les meubles volumineux ne passent presque jamais par l'escalier. On prévoit donc systématiquement le monte-meuble par la façade pour les armoires, canapés et électroménager, chiffré dès le devis, jamais découvert le jour J."
    }, {
      t: "Une mosaïque de communes",
      p: "L'agglomération bruxelloise compte dix-neuf communes, chacune avec ses règles de stationnement et ses autorisations. Ixelles, Saint-Gilles, Etterbeek, le centre : le stationnement résidentiel y est réglementé et il faut souvent réserver un emplacement de déménagement à l'avance auprès de la commune. On gère cette démarche en amont pour garantir une place au camion devant chez vous, sans amende ni perte de temps."
    }, {
      t: "Capitale européenne, beaucoup d'expatriés",
      p: "Siège des institutions européennes et de l'OTAN, Bruxelles attire fonctionnaires, lobbyistes, diplomates et cadres internationaux. Une grande part des Nice–Bruxelles relève de la mobilité professionnelle. On remet un devis conforme à transmettre à l'employeur ou à l'institution, une facture en règle, et on coordonne avec votre prise de poste. L'inventaire détaillé sert aussi à votre dossier d'installation."
    }, {
      t: "1 150 km en direct, sans groupage",
      p: "Sur une distance européenne comme Nice–Bruxelles, le groupage est tentant pour les déménageurs, mais coûteux en délais et en risques pour vous. Nous, c'est un camion dédié, plombé au départ de Nice, avec un arrimage renforcé pour les onze heures de route. Une seule équipe assure le chargement et la livraison. Le transport demande une à deux journées selon le déchargement, avec une fenêtre annoncée et tenue."
    }],
    faq: [{
      q: "Y a-t-il des formalités douanières pour la Belgique ?",
      a: "Non, la Belgique est dans l'Union européenne : pas de douane. On fournit un inventaire détaillé et on gère toute la logistique de la traversée."
    }, {
      q: "Combien de temps de trajet pour un Nice–Bruxelles ?",
      a: "≈ 1 150 km : le transport demande une à deux journées selon le déchargement, avec une fenêtre de livraison annoncée au devis."
    }, {
      q: "Gérez-vous les maisons à escaliers étroits ?",
      a: "Oui, c'est typique de Bruxelles : on prévoit le monte-meuble par la façade dès le devis pour les meubles qui ne passent pas par l'escalier."
    }, {
      q: "Et le stationnement dans les communes bruxelloises ?",
      a: "On réserve un emplacement de déménagement à l'avance auprès de la commune concernée, pour garantir une place au camion devant chez vous."
    }, {
      q: "Gérez-vous les mutations vers les institutions européennes ?",
      a: "Oui, fréquent à Bruxelles : devis conforme pour votre employeur ou institution, facture en règle et coordination avec votre prise de poste."
    }]
  },
  "nice-luxembourg": {
    from: "Nice",
    ...
    points: [{
      t: "Mobilité professionnelle",
      d: "Devis conforme pour votre employeur ou service RH et facture en règle pour le remboursement de vos frais de déménagement."
    }, {
      t: "Trajet européen direct",
      d: "≈ 920 km : une seule équipe, camion dédié et plombé, délais tenus et fenêtre de livraison annoncée."
    }, {
      t: "Union européenne",
      d: "Pas de douane : un inventaire détaillé suffit. On s'occupe de toute la logistique de la traversée."
    }],
    deep: [{
      t: "Le déménagement de la prise de poste",
      p: "Luxembourg attire des actifs du monde entier, notamment dans la banque, l'assurance et les institutions européennes. Nos Nice–Luxembourg sont presque toujours des mobilités professionnelles, avec un calendrier dicté par une date d'embauche. On s'y adapte : devis conforme à transmettre à votre employeur ou service RH, facture en règle pour le remboursement, et un déménagement calé sur votre prise de fonction, sans risquer d'arriver après votre premier jour."
    }, {
      t: "Une ville-centre dense et verticale",
      p: "La ville de Luxembourg est compacte et contrastée : la vieille ville perchée et ses ruelles, le plateau du Kirchberg et ses immeubles modernes où siègent banques et institutions, les quartiers résidentiels de Limpertsberg ou Belair. Accès, ascenseurs et stationnement varient fortement. On repère votre adresse pour prévoir le bon véhicule, le portage et, si besoin, un monte-meuble pour les immeubles anciens de la vieille ville."
    }, {
      t: "Pas de douane, mais de la rigueur",
      p: "Le Luxembourg étant dans l'UE, aucune formalité douanière : un inventaire détaillé de vos biens suffit. Cela ne dispense pas de rigueur logistique sur 920 km. On planifie l'itinéraire, on arrime soigneusement pour la longue route et on annonce une fenêtre de livraison fiable. Camion dédié et plombé, pas de groupage : vos affaires ne transitent pas par un entrepôt en attendant un autre chargement."
    }, {
      t: "Garde-meuble relais des deux côtés",
    ...
    faq: [{
      q: "C'est souvent une mutation, vous gérez ce cas ?",
      a: "Oui, c'est la majorité de nos Nice–Luxembourg : devis conforme à transmettre à votre employeur, facture en règle, et déménagement coordonné avec votre prise de poste."
    }, {
      q: "Y a-t-il des formalités douanières ?",
      a: "Non, le Luxembourg est dans l'Union européenne : un inventaire détaillé suffit, on s'occupe de toute la logistique."
    }, {
      q: "Combien de temps dure le trajet ?",
  ...
  "nice-barcelone": {
    ...
    faq: [{
      ...
      a: "Non, l'Espagne est dans l'Union européenne : pas de douane. On fournit un inventaire détaillé et on gère toute la logistique jusqu'à Barcelone."
    }, {
      q: "Les ascenseurs barcelonais sont minuscules, comment faites-vous ?",
      a: "C'est le grand classique de l'Eixample : on prévoit le monte-meuble par le balcon ou la façade dès le devis pour les meubles qui n'entrent pas dans l'ascenseur."
    }, {
      q: "Combien de temps de route jusqu'à Barcelone ?",
      a: "≈ 660 km le long de la côte, soit une bonne journée de route. La fenêtre de livraison est annoncée au devis."
    }, {
      q: "Gérez-vous les ruelles du Barri Gòtic ?",
      a: "Oui : portage et stationnement réservé au plus près, puisque le camion n'entre pas dans les ruelles médiévales et piétonnes."
    }, {
      q: "Faites-vous les mutations professionnelles vers Barcelone ?",
      a: "Oui : devis conforme pour votre employeur, facture en règle, et inventaire détaillé qui facilite aussi votre installation côté espagnol."
    }]
  },
  "nice-madrid": {
    from: "Nice",
    ...
    faq: [{
      q: "Combien de jours pour un Nice–Madrid ?",
      a: "≈ 1 280 km : comptez une à deux journées de transport selon le déchargement, avec une fenêtre de livraison annoncée au devis."
    }, {
      q: "Y a-t-il des papiers de douane ?",
      a: "Non, l'Espagne est dans l'Union européenne : un inventaire détaillé suffit, on s'occupe de toute la logistique."
    }, {
      q: "Mon mobilier est-il assuré sur tout le trajet ?",
      a: "Oui, assurance incluse du chargement à la livraison, sur l'intégralité des 1 280 km, avec un arrimage renforcé pour la longue route."
    }, {
      q: "Gérez-vous le centre de Madrid et ses ascenseurs étroits ?",
      a: "Oui : stationnement réservé, portage, et monte-meuble pour les immeubles anciens de Centro, Salamanca ou Chamberí."
    }, {
      q: "Faites-vous du groupage ou un camion dédié ?",
      a: "Un camion dédié à votre seul chargement, plombé au départ. Pas de groupage ni de transbordement, une seule équipe jusqu'à Madrid."
    }]
  },
  "nice-milan": {
    from: "Nice",
    ...
    points: [{
      t: "Frontière voisine",
      d: "≈ 320 km via la Riviera et l'autoroute des fleurs : trajet court, souvent réalisable dans la journée, camion dédié."
    }, {
      t: "Cours et ascenseurs milanais",
      d: "Immeubles à cortile et ascenseurs étroits typiques de Milan : portage et monte-meuble anticipés dès le devis."
    }, {
      t: "Union européenne",
      d: "Pas de douane : un inventaire détaillé suffit. On gère la logistique et les accès réglementés du centre."
    }],
    deep: [{
      t: "Les cortile et la ZTL milanaise",
      p: "Milan a deux particularités que tout déménageur local connaît. D'abord les cortile, ces cours intérieures par lesquelles on accède à beaucoup d'immeubles, avec des passages voûtés et des ascenseurs souvent étroits : le monte-meuble est fréquemment nécessaire pour les gros volumes. Ensuite la ZTL, la zone à trafic limité du centre, à l'accès réglementé. On anticipe l'autorisation d'accès et on prévoit le bon équipement dès le devis."
    }, {
      t: "Un trajet international express",
      p: "À ≈ 320 km par la Riviera et l'autoroute des fleurs, Milan est l'une de nos destinations internationales les plus proches : le chargement à Nice et la livraison à Milan sont souvent réalisables dans la même journée. La frontière italienne, au sein de l'UE, se passe sans formalité douanière. Camion dédié et plombé, une seule équipe : la proximité rend ce déménagement international aussi fluide qu'un long trajet français."
    }, {
      t: "Capitale économique et de la mode",
      p: "Milan est le moteur économique de l'Italie et une capitale mondiale de la mode et du design : elle attire cadres, créatifs et expatriés. Nos Nice–Milan sont souvent des installations professionnelles. On remet un devis conforme pour l'employeur et une facture en règle, et on coordonne avec votre prise de poste. Du studio du centre à l'appartement familial des quartiers résidentiels, on adapte l'équipe au volume."
    }, {
      t: "Proximité, prix maîtrisé",
      p: "La courte distance fait de Nice–Milan un déménagement international au coût contenu, même pour un petit volume. Pas d'attente en entrepôt, pas de groupage : un camion dédié, une livraison rapide et un devis ferme malgré la frontière. Et si votre logement milanais n'est pas prêt, on propose un garde-meuble relais en box sécurisé, à Nice ou à l'arrivée, le temps que tout se cale."
    }],
    faq: [{
      q: "Un Nice–Milan se fait en une journée ?",
      a: "Souvent oui : ≈ 320 km, frontière voisine. Chargement et livraison sont fréquemment réalisables dans la même journée selon le volume."
    }, {
      q: "Y a-t-il des formalités pour l'Italie ?",
      a: "Non, l'Italie est dans l'Union européenne : un inventaire détaillé suffit, on s'occupe du reste."
    }, {
      q: "Gérez-vous les cours d'immeubles et la ZTL milanaises ?",
      a: "Oui : monte-meuble pour les cortile et ascenseurs étroits, et autorisation d'accès anticipée pour la zone à trafic limité du centre."
    }, {
      q: "Le prix est-il ferme malgré la frontière ?",
      a: "Oui, le devis est détaillé et définitif. La proximité et l'absence de douane rendent ce trajet international simple et maîtrisé."
    }, {
      q: "Faites-vous les mutations professionnelles vers Milan ?",
      a: "Oui : devis conforme pour votre employeur, facture en règle et coordination avec votre prise de poste."
    }]
  },
  "nice-turin": {
    from: "Nice",
    ...
    points: [{
      t: "Trajet par la montagne",
      d: "≈ 230 km via le col de Tende ou le tunnel : chauffeurs habitués au passage transfrontalier alpin, planning calé en conséquence."
    }, {
      t: "Immeubles turinois",
      d: "Bâtisses anciennes à hauts plafonds et cages d'escalier étroites : monte-meuble prévu dès le devis si besoin."
    }, {
      t: "Union européenne",
      d: "Pas de douane : un inventaire détaillé suffit. On gère toute la logistique jusqu'à Turin."
    }],
    deep: [{
      t: "Le passage des Alpes",
      p: "Contrairement aux autres trajets italiens côtiers, Nice–Turin se fait par la montagne : la vallée de la Roya, puis le col de Tende ou son tunnel pour basculer côté piémontais. Nos chauffeurs connaissent ce passage transfrontalier alpin et son éventuelle météo. On cale le planning en conséquence, surtout en hiver, pour que le trajet reste fluide et sûr. La frontière, au sein de l'UE, se passe sans formalité douanière."
    }, {
      t: "Turin, l'élégance baroque",
      p: "Turin est une ville à l'urbanisme rigoureux et baroque : larges avenues à arcades, immeubles anciens aux hauts plafonds et aux belles cages d'escalier, mais souvent étroites pour les meubles modernes. Le centre, autour de la Mole et de la place San Carlo, est dense et en partie réglementé (ZTL). On repère l'accès pour prévoir le portage, le stationnement réservé et un monte-meuble quand l'escalier ancien ne laisse pas passer les volumes."
    }, {
      t: "Une proximité méconnue",
      p: "Beaucoup ignorent que Turin n'est qu'à ≈ 230 km de Nice, soit moins de trois heures de route : c'est plus proche que Marseille n'est de certaines villes. Résultat, un déménagement international souvent réalisable dans la journée, au coût contenu même pour un petit volume. Camion dédié, une seule équipe, pas de groupage : la frontière ne complique rien quand on connaît le passage."
    }, {
      t: "Familles, étudiants et mutations",
      p: "Ville universitaire et industrielle (berceau de Fiat), Turin accueille étudiants, actifs et familles, dont beaucoup de liens transfrontaliers avec la Côte d'Azur. Nos Nice–Turin couvrent installations professionnelles, rapprochements familiaux et retours au pays. Pour une mutation, devis conforme et facture en règle. Du studio à l'appartement familial, on adapte l'équipe, et un garde-meuble relais est possible si vos dates ne coïncident pas."
    }],
    faq: [{
      q: "Combien de temps pour un Nice–Turin ?",
      a: "≈ 230 km, soit moins de 3 h de route par la montagne : c'est souvent réalisable dans la journée, chargement et livraison rapprochés."
    }, {
      q: "Y a-t-il des formalités douanières ?",
      a: "Non, l'Italie est dans l'Union européenne : un inventaire détaillé suffit, on s'occupe de toute la logistique."
    }, {
      q: "La montagne complique-t-elle le trajet ?",
      a: "Non : nos chauffeurs connaissent le passage transfrontalier par le col ou le tunnel. On cale le planning en conséquence, surtout en hiver."
    }, {
      q: "Gérez-vous le centre de Turin et sa ZTL ?",
      a: "Oui : stationnement réservé, portage et monte-meuble pour les immeubles anciens, et autorisation anticipée pour la zone à trafic limité du centre."
    }, {
      q: "Le déménagement reste-t-il économique ?",
      a: "Oui : la courte distance rend ce trajet international accessible, même pour un petit volume. Devis ferme, frontière comprise."
    }]
  }
};
...
Object.assign(window, {
  ...
  try { Object.assign(window, { getRoute }); } catch (e) {}
})();
