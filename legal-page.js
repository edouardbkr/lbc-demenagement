...
function CGV() {
  ...
  }, React.createElement("p", null, "Les pr\xE9sentes conditions g\xE9n\xE9rales de vente (CGV) r\xE9gissent les prestations de d\xE9m\xE9nagement et les services associ\xE9s fournis par ", React.createElement("strong", null, "LBC D\xE9m\xE9nagement D\xC9M\xC9NAGEMENT"), ", SAS au capital de 3\xA0000\xA0\u20AC, dont le si\xE8ge est 12 rue d'Italie, 06000 Nice, SIRET 106\xA0789\xA0860\xA000017, RCS Nice, code APE 4942Z, \xE0 ses clients particuliers et professionnels."), React.createElement("p", null, "LBC D\xE9m\xE9nagement exerce sous l'attestation de capacit\xE9 professionnelle en transport routier l\xE9ger de marchandises n\xB0\xA0JME932603100."), React.createElement("p", null, "Toute commande implique l'acceptation pleine et enti\xE8re des pr\xE9sentes CGV. Elles sont remises au client avec le devis et sont consultables \xE0 tout moment sur ", React.createElement("a", {
    href: "CGV"
  }, "lbcdemenagement.com"), ".")), React.createElement(LBlock, {
    n: "2",
    title: "Devis et commande"
  }, React.createElement("p", null, "Chaque prestation fait l'objet d'un devis gratuit, personnalis\xE9 et sans engagement, ", React.createElement("strong", null, "valable 15\xA0jours"), " ; pass\xE9 ce d\xE9lai, il peut \xEAtre r\xE9actualis\xE9 sur simple demande. Le devis d\xE9taille la formule retenue, l'inventaire d\xE9clar\xE9, le volume estim\xE9, les moyens engag\xE9s et le prix."), React.createElement("p", null, React.createElement("strong", null, "La date du d\xE9m\xE9nagement n'est r\xE9serv\xE9e qu'\xE0 r\xE9ception de l'acompte."), " Tant qu'il n'est pas vers\xE9, le cr\xE9neau reste disponible pour un autre client, m\xEAme si un devis a \xE9t\xE9 \xE9mis."), React.createElement("p", null, "La commande devient ferme \xE0 la signature du devis et au versement de l'acompte. Le devis sign\xE9 pr\xE9vaut sur toute estimation indicative affich\xE9e sur le site ou communiqu\xE9e par t\xE9l\xE9phone.")), React.createElement(LBlock, {
    n: "3",
