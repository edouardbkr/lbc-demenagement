...
function CGV() {
  ...
  }, React.createElement("p", null, "Chaque prestation fait l'objet d'un devis gratuit et personnalis\xE9, valable ", React.createElement("strong", null, "30\xA0jours"), ". La commande est ferme \xE0 la signature du devis et au versement de l'acompte \xE9ventuel. Le devis sign\xE9 pr\xE9vaut sur toute estimation indicative affich\xE9e sur le site.")), React.createElement(LBlock, {
    n: "3",
    title: "Prix et paiement"
  }, React.createElement("p", null, "Les prix sont indiqu\xE9s en euros, ", React.createElement("strong", null, "nets de taxe"), "\xA0: TVA non applicable, article\xA0293\xA0B du Code g\xE9n\xE9ral des imp\xF4ts. Un acompte de ", React.createElement("strong", null, "30\xA0%"), " peut \xEAtre demand\xE9 \xE0 la r\xE9servation pour bloquer la date\xA0; le solde est exigible ", React.createElement("strong", null, "le jour de la prestation, \xE0 la fin du d\xE9chargement"), ". Moyens de paiement accept\xE9s\xA0: carte, virement, ch\xE8que ou esp\xE8ces.")), React.createElement(LBlock, {
    n: "4",
